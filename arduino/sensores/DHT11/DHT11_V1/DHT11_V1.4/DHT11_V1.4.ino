...
#define TEMPERATURE_PUBLISHING_PERIOD 300 //seconds
#define HUMIDITY_PUBLISHING_PERIOD 300 //seconds
#define MIDDLE_DELAY 60 //seconds
...
void setup() {
  ...
  char *message_pub = "";
  message = String(dht.getMinimumSamplingPeriod());
...
void loop() {
  ...
  delay(TEMPERATURE_PUBLISHING_PERIOD * 1000);
}
