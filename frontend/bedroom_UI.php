...
<body>
   <div><form action="http://192.168.1.187/Domo/index.php" method="get">
    ...
    if ($result->num_rows > 0) {
	    ...
	    if($row["MEANING"] == 'R'){
                if($row["VALUE"] == 'ON'){
                    echo '<form action="http://192.168.1.187/Domo/php/update_parameter.php" method="get">
...
<!-- PROTOCOLS -->
    ...
    <form action="http://192.168.1.187/Domo/php/protocols/proto_photo_C.php" method="get">
    <button name="TOPIC" class='atc_button' type="submit" value="home/bedroom/C" style="margin: 10px 10px 10px 60px;">Camera</button>
    </form>
    <form action="http://192.168.1.187/Domo/php/protocols/proto_sunset_L.php" method="get">
    <button name="TOPIC" class='atc_button' type="submit" value="home/bedroom/L" style="margin: 10px 10px 10px 60px;">Sunset</button>
    </form>
    <form action="http://192.168.1.187/Domo/php/protocols/proto_sunrise_L.php" method="get">
